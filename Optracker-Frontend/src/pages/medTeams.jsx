...
function MedTeams() {
    const equipo = [
        { nombre: 'Dr. Sarah Smith', especialidad: 'Orthopedic Surgeon', tipo: 'Doctor' },
        { nombre: 'Dr. Alex Johnson', especialidad: 'Anesthesiologist', tipo: 'Doctor' },
        { nombre: 'Dr. Michael Brown', especialidad: 'Cardiothoracic Surgeon', tipo: 'Doctor' },
        { nombre: 'Dr. Emily Davis', especialidad: 'Neurosurgeon', tipo: 'Doctor' },
        { nombre: 'Dr. Robert Miller', especialidad: 'Enfermero quirúrgico', tipo: 'Enfermero' },
        { nombre: 'Dr. Laura Wilson', especialidad: 'Enfermero de urgencias', tipo: 'Enfermero' },
        { nombre: 'Dr. Daniel Taylor', especialidad: 'Enfermero de urgencias', tipo: 'Enfermero' },
        { nombre: 'Dr. Olivia Martinez', especialidad: 'Pediatric Surgeon', tipo: 'Doctor' },
        { nombre: 'Dr. Sophia Garcia', especialidad: 'Enfermero General', tipo: 'Enfermero' },
      ];
