    ...
    const familyCode = [
        {
            ...
            description: "Recibe información precisa y actualizada sobre cada paso del procedimiento quirúrgico."
        },
        {
            ...
            title: "Fácil de usar",
            description: "Solo necesitas un código único para acceder al estado del paciente."
        },
        {
            ...
            description: "Todos los datos están protegidos con altos estándares de seguridad."
        }
    ];
                    ...
                    <div className="flex flex-1 justify-center items-start px-40 py-5 size-full max-md:px-5 max-md:max-w-full">
                        <div className="flex overflow-hidden flex-col flex-1 shrink w-full basis-0 max-w-[960px] min-w-[240px] max-md:max-w-full">
                            <div className="flex flex-col w-full max-md:max-w-full">
                                ...
                                />
                                <div className="absolute top-72 left-1/3 transform -translate-x-12 text-center"> {/* Alineación del título y subtítulo */}
                                    <h1 className="text-6xl font-bold text-white mb-2">OpTracker</h1> {/* Título grande */}
                                </div>
                                <div className="absolute top-80 left-1/3 transform -translate-x-10 text-center"> {/* Alineación del subtítulo */}
                                    <p className="text-white mt-10">Accede al estado de tu ser querido en tiempo real</p> {/* Subtítulo */}
                                </div>
                                <div className="absolute top-96 left-1/2 transform -translate-x-1/2 mb-5 flex items-center space-x-2"> {/* Cuadro de texto y botón alineados */}
                                    <FormInput
                                        label=""
                                        id="accessCode"
                                        placeholder="Ingresa tu código"
                                        required
                                        className="p-4 w-full max-w-[1000px]" // Estilo del cuadro de texto más largo
                                    />
                                    <button className="p-4 bg-blue-500 text-white rounded w-[180px] mt-1">Consultar estado</button> {/* Botón actualizado con ancho reducido y desplazado hacia abajo */}
                                </div>
                            </div>
