          ...
          <div className="flex flex-1 justify-center items-start px-40 py-5 size-full max-md:px-5 max-md:max-w-full">
            <div className="flex overflow-hidden flex-col flex-1 shrink w-full basis-0 max-w-[960px] min-w-[240px] max-md:max-w-full">
              <div className="flex flex-col w-full max-md:max-w-full">
                ...
                <div className="absolute top-96 left-1/2 transform -translate-x-1/2 mb-5 flex items-center space-x-2">
                  {" "}
                  {/* Cuadro de texto y botón alineados */}
                  <FormInput
                    label=""
                    id="accessCode"
                  ...
                  />
                  <button className="p-4 bg-cyan-600 text-white rounded-lg w-[180px] mt-1">
                    Consultar estado
                  </button>{" "}
                  {/* Botón actualizado con ancho reducido y desplazado hacia abajo */}
                </div>
              </div>
