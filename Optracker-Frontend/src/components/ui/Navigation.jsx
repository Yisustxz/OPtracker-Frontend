...
function Navigation() {
  const navItems = [
    { label: "Inicio", width: "w-[40px]" }, 
    { label: "Equipo medico", width: "w-[90px]" },
    { label: "Paciente", width: "w-[50px]" },
    { label: "Cirugia", width: "w-[50px]" }
  ];
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-10 flex flex-wrap justify-between items-center px-10 py-3 w-full bg-white border-b border-gray-200 max-md:px-5 max-md:max-w-full">
      ...
      <div className="flex items-center justify-center my-auto w-[37px]"> {/* Cambiado para alinear el botón */}
        <button
