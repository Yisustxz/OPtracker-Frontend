...
export default function EmergencyContact({ name, phoneNumber, email, lastName, image }) {
  return (
    <div className="flex flex-wrap gap-4 items-center px-4 py-2 w-full bg-white min-h-[72px] max-md:max-w-full">
      ...
      <div className="flex flex-col justify-center self-stretch my-auto w-[300px]">
        ...
        <div className="flex overflow-hidden flex-col max-w-full text-sm whitespace-nowrap text-slate-500 w-[300px]">
          <div>{phoneNumber}</div>
          <div>{email}</div>
        </div>
      </div>
